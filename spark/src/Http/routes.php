...
$router->group(['middleware' => 'web'], function ($router) {
    ...
    $router->get('/register/confirm/{token}', 'Auth\RegisterController@confirmEmail');
    $router->get('/register/invite/{token}', 'Auth\RegisterController@inviteCustomer')->name('customer_invitation');
    $router->post('/register/invite', 'Auth\RegisterController@postInviteCustomer')->name('post_customer_invitation'); 	
